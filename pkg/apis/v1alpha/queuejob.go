...
func CreateQueueJob(clientset apiextcs.Interface) error {
	crd := &apiextv1beta1.CustomResourceDefinition{
		ObjectMeta: metav1.ObjectMeta{Name: FullQueueJobName},
		Spec: apiextv1beta1.CustomResourceDefinitionSpec{
			...
			Names: apiextv1beta1.CustomResourceDefinitionNames{
				...
				Kind: reflect.TypeOf(QueueJob{}).Name(),
			},
		},
	}
...
var SchemeGroupVersion = schema.GroupVersion{Group: QueueJobGroup, Version: QueueJObVersion}
